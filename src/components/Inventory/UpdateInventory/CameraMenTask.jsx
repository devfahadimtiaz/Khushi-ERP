...
import main from "../../../assets/uploads/Stock Photos/main.png"

const CameraMenTask = ({cameraMenPhotoFiles, setCameraMenPhotosFiles, camperaMenVideosFiles, setCameraMenVideosFiles}) => {


  const handleVideoUpload = (e) => {
    if (e.target.files) {
      setCameraMenVideosFiles([...camperaMenVideosFiles, ...Array.from(e.target.files)]);
    }
  };

  const handlePhotoUpload = (e) => {
    if (e.target.files) {
      setCameraMenPhotosFiles([...cameraMenPhotoFiles, ...Array.from(e.target.files)]);
    }
  };
  ...
  const handleVideoDrop = (e) => {
    ...
    if (e.dataTransfer.files) {
      setCameraMenVideosFiles([...camperaMenVideosFiles, ...Array.from(e.dataTransfer.files)]);
    }
  };
  ...
  const handlePhotoDrop = (e) => {
    e.preventDefault();
    if (e.dataTransfer.files) {
      setCameraMenPhotosFiles([...cameraMenPhotoFiles, ...Array.from(e.dataTransfer.files)]);
    }
  };
  const handleDeletePhoto = (index) => {
    const updatedPhotos = [...cameraMenPhotoFiles];
    updatedPhotos.splice(index, 1);
    setCameraMenPhotosFiles(updatedPhotos);
  };

  const handleDeleteVideo = (index) => {
    const updatedVideos = [...camperaMenVideosFiles];
    updatedVideos.splice(index, 1);
    setCameraMenVideosFiles(updatedVideos);
  };
    useEffect(() => {
      return () => {
        cameraMenPhotoFiles.forEach((file) => URL.revokeObjectURL(file));
        camperaMenVideosFiles.forEach((file) => URL.revokeObjectURL(file));
      };
            ...
            <div className={styles.approvalCard}>
              <div className={styles.approvalOptions}>
                <div className={styles.approvalOption}>
                  ...
                  />
                  <label htmlFor="approved1">Approved</label>
                </div>
                <div className={styles.approvalOption}>
                  <input
                    type="radio"
                    ...
                    className={styles.approvalCheckbox}
                  />
                  <label htmlFor="not-approved1">Not Approved</label>
                </div>
                <div className={styles.approvalOption}>
                  <span>Remarks</span>
              ...
              <div className={styles.approvalOptions}>
                <div className={styles.approvalOption}>
                  <input
                    ...
                    className={styles.approvalCheckbox}
                  />
                  <label htmlFor="approved2">Approved</label>
                </div>
                <div className={styles.approvalOption}>
                  <input
                    type="radio"
                    ...
                    className={styles.approvalCheckbox}
                  />
                  <label htmlFor="not-approved2">Not Approved</label>
                </div>
                <div className={styles.approvalOption}>
                  <span>Remarks</span>
                  <input type="text" className={styles.remarksInput} />
