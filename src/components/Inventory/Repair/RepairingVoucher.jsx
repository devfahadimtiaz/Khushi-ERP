...
const RepairingVoucher = ({ vehicleId, voucherName, voucherId  }) => {
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    if (!vehicleId) return;
    axios
      .get(`${API_URL}/repairingVoucher/${vehicleId}`)
      .then((res) => {
        setData(res.data);
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <div className={styles.headerTitle}>{voucherName ||"REPAIRING"} VOUCHER</div>
      </div>
      ...
      <div className={styles.totalContainer}>
        ...
        <div className={styles.totalAmount}>
          ...
          <div className={styles.totalAmount}>{data.total_amount}</div>
        </div>
      </div>
