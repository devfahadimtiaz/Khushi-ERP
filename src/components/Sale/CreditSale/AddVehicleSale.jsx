          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="tab-content">
                {activeTab === "buyer" && <BuyerDetails />}
                {activeTab === "nominee" && <NomineeDetails />}
                {activeTab === "guarantor" && <GuarantorDetails />}
                {activeTab === "pricing" && <InstallmentCalculator />}
              </div>
            </div>
