    ...
    <div className={styles.container}>
      <div className={styles.contentWrapper}>
        <div className={styles.header}>
          <div className={styles.title}>Add New Bank</div>
        </div>
        ...
        <thead className={styles.tableHeader}>
          ...
          <th className={styles.headerCell}>Branch Name</th>
          <th className={styles.headerCell}>IBAN#</th>
          ...
          <tr className={styles.tableRow}>
            ...
            <td className={styles.tableCell}><input type="text" name="" id="" className={styles.codeTag} placeholder="Enter Bank"/></td>
            <td className={styles.tableCell}><input type="text" name="" id="" className={styles.codeTag} placeholder="Enter IBAN"/></td>
