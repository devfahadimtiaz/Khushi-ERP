    ...
    <div className={styles.container}>
      <div className={styles.contentWrapper}>
        <div className={styles.header}>
          <div className={styles.title}>Add Credit Account Details</div>
        </div>
        <div className={styles.contentPanel}>
            <div className={styles.filterHeader}>
              <div className={styles.filterLabel}>Credit Account Name</div>
              <div className={styles.filterLabel}>Discription</div>
            </div>
            <div className={styles.filterControls}>
      
                <input type="text" placeholder="Credit" className={styles.searchInput}/>
