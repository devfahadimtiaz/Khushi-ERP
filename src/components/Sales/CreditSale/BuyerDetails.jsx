      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.formHeader}>
          <div className={styles.formHeaderLeft}>
            <div className={styles.label}>Installments Id</div>
          </div>
        ...
        <div className={styles.formRow}>
          <input
            ...
            placeholder="Fetch from previous screen"
          />
        ...
        <input type="text" className={styles.inputFieldFull} placeholder="Month"/>
        <div className={styles.formRowLabels}>
          <div className={styles.label}>Select Division</div>
          <div className={styles.label}>Installment Type</div>
        </div>
        <div className={styles.formRow}>
          <input type="text" className={styles.inputField} placeholder="Select Division"/>
          <input type="text" className={styles.inputField} placeholder="Installment Type"/>
        </div>
