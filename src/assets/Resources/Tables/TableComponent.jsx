...
const TableComponent = ({ HeadData, data, onView, onEdit, onDelete }) => {
  ...
  const ViewIcon = () => (
    <svg width="20" height="20" fill="none" viewBox="0 0 20 20" className={styles.iconSvg}>
      <path
      ...
      />
      <path
        d="M10 13.125C11.73 13.125 13.125 11.73 13.125 10C13.125 8.27 11.73 6.875 10 6.875C8.27 6.875 6.875 8.27 6.875 10C6.875 11.73 8.27 13.125 10 13.125Z"
        stroke="#344054"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
