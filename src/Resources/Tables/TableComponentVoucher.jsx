...
import styles from "./TableComponentVoucher.module.css";
...
const TableComponenet = ({ HeadData, data, onView, onEdit, onDelete }) => {
  ...
  const filteredData = data.filter((row) => {
    const rowDate = new Date(row.date); // Replace 'date' with your actual date field key
  ...
  return (
    <>
      <div className={styles.buttonArea} >
        ...
        <button className={styles.addButton} onClick={handleReset}>
          <span>Reset</span>
        </button>
      </div>
